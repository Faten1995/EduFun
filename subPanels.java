...
public class subPanels extends JPanel {
		...
		subPanels()
		{
			...
			firstQ.add(new JLabel(new ImageIcon("q1sub.jpg")), BorderLayout.CENTER);
			...
			if(i==14){
				JOptionPane.showMessageDialog(null," 14 is correct\nWell Done :)");
			} else {
			...
			secondQ.add(new JLabel(new ImageIcon("q2sub.jpg")), BorderLayout.CENTER);
			...
			check2.addActionListener(new ActionListener() {
					...
					if(i==32)
							{
					JOptionPane.showMessageDialog(null," 32 is correct\nWell Done :)");
						//cl.show(panelCont, "3");
							}
					else {
						JOptionPane.showMessageDialog(null," \ntry again ");
			...
			thirdQ.add(new JLabel(new ImageIcon("q3sub.jpg")), BorderLayout.CENTER);
			...
			int i =  Integer.parseInt(t3.getText());
				if(i==18)
					{
				JOptionPane.showMessageDialog(null," 18 is correct\nWell Done :)");
					}
				else {
				JOptionPane.showMessageDialog(null," \ntry again ");
					}
			...
			fourthQ.add(new JLabel(new ImageIcon("q4sub.jpg")), BorderLayout.CENTER);
			...
			if(i==64){
			JOptionPane.showMessageDialog(null," 64 is correct\nWell Done :)");
			}else {
			JOptionPane.showMessageDialog(null," \ntry again ");}
				} catch (Exception e2) {
			JOptionPane.showMessageDialog(null," \nError: Reenter integer Number. ");
			...
			fifthQ.add(new JLabel(new ImageIcon("q5sub.jpg")), BorderLayout.CENTER);
			...
			if(i==63){
			JOptionPane.showMessageDialog(null," 63 is correct\nWell Done :)");
			}else {
			JOptionPane.showMessageDialog(null," \ntry again ");}
				} catch (Exception e2) {
			JOptionPane.showMessageDialog(null," \nError: Reenter integer Number. ");

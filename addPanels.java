...
public class addPanels extends JPanel {
		...
		addPanels()
		{
			...
			firstQ.add(new JLabel(new ImageIcon("q1add.jpg")), BorderLayout.CENTER);
			...
			secondQ.add(new JLabel(new ImageIcon("q2add.jpg")), BorderLayout.CENTER);
			...
			check2.addActionListener(new ActionListener() {
					...
					if(i==39)
							{
					JOptionPane.showMessageDialog(null," 39 is correct\nWell Done :)");
						//cl.show(panelCont, "3");
							}
					else {
						JOptionPane.showMessageDialog(null," \ntry again ");
			...
			thirdQ.add(new JLabel(new ImageIcon("q3add.jpg")), BorderLayout.CENTER);
			...
			int i =  Integer.parseInt(t3.getText());
				if(i==105)
					{
				JOptionPane.showMessageDialog(null," 105 is correct\nWell Done :)");
					}
				else {
				JOptionPane.showMessageDialog(null," \ntry again ");
					}
			...
			fourthQ.add(new JLabel(new ImageIcon("q4add.jpg")), BorderLayout.CENTER);
			...
			if(i==90){
			JOptionPane.showMessageDialog(null," 90 is correct\nWell Done :)");
			}else {
			JOptionPane.showMessageDialog(null," \ntry again ");}
				} catch (Exception e2) {
			JOptionPane.showMessageDialog(null," \nError: Reenter integer Number. ");
			...
			fifthQ.add(new JLabel(new ImageIcon("q5add.jpg")), BorderLayout.CENTER);

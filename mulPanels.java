...
public class mulPanels extends JPanel {
		...
		mulPanels()
		{
			...
			firstQ.add(new JLabel(new ImageIcon("q1mul.jpg")), BorderLayout.CENTER);
			...
			check1.addActionListener(new ActionListener() {
				...
				if(i==34)
				{
					JOptionPane.showMessageDialog(null," 34 is correct\nWell Done :)");
				}
				else {
			...
			secondQ.add(new JLabel(new ImageIcon("q2mul.jpg")), BorderLayout.CENTER);
			...
			check2.addActionListener(new ActionListener() {
					...
					if(i==24)
							{
					JOptionPane.showMessageDialog(null," 24 is correct\nWell Done :)");
						//cl.show(panelCont, "3");
							}
					else {
						JOptionPane.showMessageDialog(null," \ntry again ");
			...
			thirdQ.add(new JLabel(new ImageIcon("q3mul.jpg")), BorderLayout.CENTER);
			...
			int i =  Integer.parseInt(t3.getText());
				if(i==0)
					{
				JOptionPane.showMessageDialog(null," 0 is correct\nWell Done :)");
					}
				else {
				JOptionPane.showMessageDialog(null," \ntry again ");
					}
			...
			fourthQ.add(new JLabel(new ImageIcon("q4mul.jpg")), BorderLayout.CENTER);
			...
			if(i==250){
			JOptionPane.showMessageDialog(null," 250 is correct\nWell Done :)");
			}else {
			JOptionPane.showMessageDialog(null," \ntry again ");}
				} catch (Exception e2) {
			JOptionPane.showMessageDialog(null," \nError: Reenter integer Number. ");
			...
			fifthQ.add(new JLabel(new ImageIcon("q5mul.jpg")), BorderLayout.CENTER);
			...
			if(i==72){
			JOptionPane.showMessageDialog(null," 72 is correct\nWell Done :)");
			}else {
			JOptionPane.showMessageDialog(null," \ntry again ");}
				} catch (Exception e2) {
			JOptionPane.showMessageDialog(null," \nError: Reenter integer Number. ");
